        ...
        <div className="w-full max-w-[768px] flex flex-col justify-start items-center gap-8">
          <div className="self-stretch flex flex-col justify-start items-center gap-4">
            <div className="inline-flex justify-start items-center">
              <div className="justify-start text-neutral-800 text-base font-semibold font-source-sans-pro leading-normal">Transformative</div>
            </div>
            <div className="self-stretch flex flex-col justify-start items-center gap-6">
              <div className="self-stretch text-center justify-start"><span className="text-neutral-800 text-7xl font-bold font-inter leading-[88px]">Empowering </span><span className="text-neutral-800 text-7xl font-medium font-inter leading-[88px]">business intelligence</span></div>
              <div className="self-stretch text-center justify-start text-neutral-800 text-lg font-normal font-source-sans-pro leading-7">Revolutionizing enterprise resource planning through autonomous AI-driven solutions for small and medium businesses</div>
            </div>
          </div>
          <div className="inline-flex justify-start items-start gap-4">
            <div className="flex justify-start items-start gap-4">
              ...
              <div className="px-6 py-3 rounded-lg outline outline-[1.50px] outline-offset-[-1.50px] outline-primary-600 flex justify-center items-center">
                <div className="justify-start text-primary-600 text-sm font-semibold font-inter leading-tight">Features</div>
              </div>
            </div>
          </div>
        </div>
