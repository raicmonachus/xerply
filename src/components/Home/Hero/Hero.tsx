...
export default function Hero() {
  ...
  // Parallax refs for desktop cards
  const salesCardRef = useParallax<HTMLDivElement>();
  const invoicesCardRef = useParallax<HTMLDivElement>();
  const cashflowCardRef = useParallax<HTMLDivElement>();
  const integrationCardRef = useParallax<HTMLDivElement>();
        ...
        <div className="w-full lg:flex-1 h-[500px] md:h-[600px] lg:h-[670px] relative order-1 lg:order-2">
          ...
          <div className="lg:hidden absolute inset-0 flex items-center justify-center">
            ...
            <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-500 ${activeCardIndex === 0 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
              <div className="w-full sm:w-80 md:w-96 px-4 md:px-6 py-3 md:py-4 bg-neutral-50 rounded-2xl shadow-lg flex justify-start items-center gap-4 md:gap-6">
            ...
            <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-500 ${activeCardIndex === 1 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
              <div className="w-full sm:w-96 md:w-[458px] px-4 md:px-6 py-3 md:py-4 bg-neutral-50 rounded-2xl shadow-lg flex flex-col justify-start items-start gap-3 md:gap-4">
            ...
            <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-500 ${activeCardIndex === 2 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
              <div className="w-full sm:w-96 md:w-[552.22px] h-60 md:h-72 px-4 md:px-6 py-3 md:py-4 bg-neutral-200 rounded-xl shadow-[0px_13.346617698669434px_33.36654281616211px_-6.673308849334717px_rgba(88,92,95,0.16)] flex flex-col justify-start items-start gap-2.5 md:gap-3.5 overflow-hidden">
                <div className="self-stretch flex flex-col sm:flex-row justify-between items-start gap-2 overflow-hidden">
                  ...
                  <div className="w-full sm:w-52 px-[4px] py-[2px] bg-primary-50 rounded outline outline-[0.83px] outline-offset-[-0.42px] outline-black-alpha-1 flex justify-start items-start gap-2">
            ...
            <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-500 ${activeCardIndex === 3 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
              <div className="w-full md:w-96 px-4 md:px-6 py-3 md:py-4 bg-neutral-100 rounded-xl shadow-lg flex justify-start items-center gap-4 md:gap-5">
          ...
          <div className="hidden lg:block">
            {/* Sales Card */}
            <div ref={salesCardRef} className="parallax-image-desktop-only w-72 sm:w-80 md:w-96 px-4 md:px-6 py-3 md:py-4 left-0 md:-left-4 top-[330px] md:top-[420px] lg:top-[460px] absolute bg-neutral-50 rounded-2xl shadow-lg flex justify-start items-center gap-4 md:gap-6">
            <div className="p-3 md:p-4 bg-primary-50 rounded-lg flex justify-start items-center gap-2.5">
              <ArrowUpRight className="w-10 h-10 md:w-12 md:h-12 text-primary-600" />
            </div>
            <div className="flex-1 flex flex-col justify-start items-start gap-1.5 md:gap-2">
          ...
          {/* Pending Invoices Card */}
          <div ref={invoicesCardRef} className="parallax-image-desktop-only w-80 sm:w-96 md:w-[458px] px-4 md:px-6 py-3 md:py-4 left-0 md:-left-4 top-0 lg:top-[-43.04px] absolute bg-neutral-50 rounded-2xl shadow-lg flex flex-col justify-start items-start gap-3 md:gap-4">
            <div className="self-stretch flex flex-col justify-start items-start gap-1">
              <div className="justify-start text-neutral-800 text-xl md:text-2xl font-bold font-inter leading-loose">Pending Invoices</div>
              <div className="self-stretch flex justify-start items-start gap-1">
                <div className="flex flex-col justify-start items-start">
          ...
          <div ref={integrationCardRef} className="parallax-image-desktop-only hidden sm:flex w-60 md:w-96 px-4 md:px-6 py-3 md:py-4 left-12 sm:left-32 md:left-[200px] top-[420px] md:top-[500px] lg:top-[580px] absolute bg-neutral-100 rounded-xl shadow-lg justify-start items-center gap-4 md:gap-5">
            <div className="flex-1 flex flex-col justify-start items-start gap-1.5">
              <div className="self-stretch py-1 flex justify-between items-center overflow-hidden">
                <div className="w-12 h-12 md:w-16 md:h-16 p-3 md:p-4 bg-primary-600 rounded-lg shadow-lg flex justify-center items-center gap-3 md:gap-5">
                  <div className="flex flex-col justify-center items-center">
