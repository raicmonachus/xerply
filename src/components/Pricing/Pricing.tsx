      ...
      <div className="self-stretch px-4 md:px-8 lg:px-16 py-12 md:py-20 lg:py-28 flex flex-col justify-start items-center gap-12 md:gap-16 lg:gap-20 overflow-hidden">
        <div className="self-stretch flex flex-col justify-start items-center gap-6 md:gap-8">
          <div className="self-stretch flex flex-col justify-start items-center gap-3 md:gap-4">
            <div className="self-stretch flex flex-col lg:flex-row justify-between items-center gap-4 lg:gap-6">
              <div className="text-center lg:text-left text-neutral-800 text-base md:text-lg font-normal font-source-sans-pro leading-relaxed">
                Perfect for small businesses getting started with intelligent ERP
              </div>
              <ToggleSwitch
          ...
          <div className="self-stretch flex flex-col md:flex-row justify-start items-stretch gap-6 md:gap-8">
            ...
            <div className="flex-1 self-stretch p-6 md:p-8 bg-neutral-200 rounded-lg outline outline-1 outline-offset-[-1px] outline-black-alpha-2/20 flex flex-col justify-start items-start gap-10 md:gap-14">
              <div className="self-stretch flex flex-col justify-start items-center gap-6 md:gap-8">
                <div className="self-stretch flex flex-col justify-start items-center gap-2">
                  ...
                  <div className="self-stretch text-center justify-start">
                    <span className="text-neutral-800 text-5xl md:text-6xl lg:text-7xl font-medium font-inter leading-tight md:leading-[88px]">$0</span>
                    <span className="text-neutral-800 text-xl md:text-2xl font-medium font-inter leading-loose">/mo</span>
                  </div>
                  <div className="self-stretch text-center justify-start text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">or $0 yearly</div>
                </div>
                <div className="self-stretch px-6 py-3 bg-primary-50 rounded-lg flex justify-center items-center cursor-pointer hover:bg-primary-100 transition-colors">
              ...
              <ul className="self-stretch py-2 pl-4 list-disc list-inside flex flex-col justify-start items-start gap-2">
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">Basic AI-powered automation tools</li>
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">Limited data integration support</li>
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">Standard reporting capabilities</li>
              </ul>
            </div>
            ...
            <div className="flex-1 self-stretch p-6 md:p-8 bg-primary-50 rounded-lg shadow-[0px_16px_32px_-12px_rgba(88,92,95,0.10)] outline outline-3 outline-offset-[-3px] outline-primary-600 flex flex-col justify-start items-start gap-10 md:gap-14">
              <div className="self-stretch flex flex-col justify-start items-center gap-6 md:gap-8">
                <div className="self-stretch flex flex-col justify-start items-center gap-2">
                  ...
                  <div className="self-stretch text-center justify-start">
                    <span className="text-neutral-800 text-5xl md:text-6xl lg:text-7xl font-medium font-inter leading-tight md:leading-[88px]">$29</span>
                    <span className="text-neutral-800 text-xl md:text-2xl font-medium font-inter leading-loose">/mo</span>
                  </div>
                  <div className="self-stretch text-center justify-start text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">or $199 yearly</div>
                </div>
                <div className="self-stretch px-6 py-3 bg-primary-600 rounded-lg flex justify-center items-center cursor-pointer hover:bg-primary-700 transition-colors">
              ...
              <ul className="self-stretch py-2 pl-4 list-disc list-inside flex flex-col justify-start items-start gap-2">
                ...
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">Limited data integration support</li>
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">Standard reporting capabilities</li>
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">Advanced machine learning capabilities</li>
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">Robust API for seamless integrations</li>
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">Customizable dashboard for analytics</li>
              </ul>
            </div>
            ...
            <div className="flex-1 self-stretch p-6 md:p-8 bg-neutral-50 rounded-lg outline outline-1 outline-offset-[-1px] outline-black-alpha-2/20 flex flex-col justify-start items-start gap-10 md:gap-14">
              <div className="self-stretch flex flex-col justify-start items-center gap-6 md:gap-8">
                <div className="self-stretch flex flex-col justify-start items-center gap-2">
                  ...
                  <div className="self-stretch text-center justify-start">
                    <span className="text-neutral-800 text-5xl md:text-6xl lg:text-7xl font-medium font-inter leading-tight md:leading-[88px]">$49</span>
                    <span className="text-neutral-800 text-xl md:text-2xl font-medium font-inter leading-loose">/mo</span>
                  </div>
                  <div className="self-stretch text-center justify-start text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">or $199 yearly</div>
                </div>
              ...
              <ul className="self-stretch py-2 pl-4 list-disc list-inside flex flex-col justify-start items-start gap-2">
                ...
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">Robust API for seamless integrations</li>
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">Customizable dashboard for analytics</li>
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">Real-time collaboration features</li>
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">User-friendly interface with drag-and-drop functionality</li>
                <li className="text-neutral-800 text-sm md:text-base font-normal font-source-sans-pro leading-normal">In-depth analytics and insights generation</li>
              </ul>
            </div>
          </div>
        </div>
